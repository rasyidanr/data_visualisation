...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_input": ["macro", 1],
                "vtp_map": ["list", ["map", "key", "economistgroup.a17.dev", "value", "UA-28292795-2"],
                    ["map", "key", "www.economistgroup.com", "value", "UA-28292795-1"]
                ]
            }, {
                "function": "__gas",
            ...
            "tags": [{
                ...
                "vtp_overrideGaSettings": false,
                "vtp_eventCategory": "sourcepoint",
                "vtp_trackType": "TRACK_EVENT",
                "vtp_gaSettings": ["macro", 3],
                "vtp_eventAction": ["template", "privacy banner: ", ["macro", 4]],
                "vtp_enableRecaptchaOption": false,
                "vtp_enableUaRlsa": false,
                "vtp_enableUseInternalVersion": false,
                "vtp_enableFirebaseCampaignData": true,
            ...
            "predicates": [{
                ...
                "function": "_re",
                "arg0": ["macro", 4],
                "arg1": "(closed)|(withdrawn)|(declined)|(provided)|(visible)",
                "ignore_case": true
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "consent.sourcepoint"
            }],
            "rules": [
                [
                    ["if", 0],
    ...
    */
        ...
        gc = function(a, b, c) {
            if (qa(a)) {
                ...
                switch (a[0]) {
                    ...
                    case "escape":
                        d = gc(a[1], b, c);
                        if (dc && qa(a[1]) && "macro" === a[1][0] && dc.Si(a)) return dc.fj(d);
                        d = String(d);
    ...
    var Lc = {};
    O.Sf = Object.freeze((Lc[O.tf] = 1, Lc[O.rh] = 1, Lc[O.Eb] = 1, Lc[O.Fb] = 1, Lc[O.sh] = 1, Lc[O.lb] = 1, Lc[O.Ud] = 1, Lc[O.nb] = 1, Lc[O.Vd] = 1, Lc[O.Gb] = 1, Lc[O.ma] = 1, Lc[O.Hb] = 1, Lc[O.na] = 1, Lc[O.uf] = 1, Lc));
    ...
    S.ud = "3e0";
    S.V = "dataLayer";
    S.lh = "ChAI8PP6kQYQ+cXg9LSpqKBfEiQA6e6LTG1RUUxeQDcUcmZ+SjM6fzWt5g0gPqyEKWzq7CTetdgaAnus";
    var Zd = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var de = Aa(""),
        ee = null,
        fe = null,
        ge = "https://www.googletagmanager.com/a?id=" + S.H + "&cv=3",
        he = {},
        le = {},
        me = function() {
            var a = U.sequence || 1;
    ...
    var ki = function(a) {},
        ...
        ri = function() {
            ...
            if (void 0 !== wi && (!xi[wi] || yi || zi))
                if (Ai[wi] || Bi.Ti() || 0 >= Ci--) Q(1), Ai[wi] = !0;
                else {
                    Bi.oj();
                    var a = qi(!0);
                    kb(a);
    ...
    var Lj = {
        ...
        Mj = {},
        Nj = Object.freeze((Mj[O.rb] = !0, Mj[O.Ec] = !0, Mj)),
        Oj = {},
    ...
    var hk = function(a, b, c) {
        try {
            if (b === c) return !1;
            var d = vb(b);
            if (d !== vb(c) || !(xb(b) && xb(c) || "array" === d)) return !0;
            if ("array" === d) {
                if (b.length !== c.length) return !0;
                for (var e = 0; e < b.length; e++)
                    if (hk(a, b[e], c[e])) return !0
            } else {
                for (var f in c)
                    if (!b.hasOwnProperty(f)) return !0;
                for (var g in b)
                    if (!c.hasOwnProperty(g) || hk(a, b[g], c[g])) return !0
            }
        } catch (l) {
            Q(72)
        }
    ...
    var xk = function(a, b, c) {
            ...
            else m = 1 === l ? a.purpose && a.vendor ? wk(a.purpose.legitimateInterests,
                                ...
                                if (Bk.hasOwnProperty(g))
                                    if ("1" === g) {
                                        ...
                                        f["1"] = n ? !1 === l.gdprApplies || "tcunavailable" === l.tcString || void 0 === l.gdprApplies &&
                                            !m || "string" !== typeof l.tcString || !l.tcString.length ? !0 : xk(l, "1", 0) : !1
                                    } else f[g] = xk(d, g, Bk[g]);
                            e = f
                        }
                        e && (a.tcString = d.tcString || "tcempty", a.Oc = e, Hk(a))
                    }
                })
            } catch (d) {
    ...
    var fl = function(a, b, c) {
            if (A[a.functionName]) return b.Ye && H(b.Ye), A[a.functionName];
            var d = el();
            A[a.functionName] = d;
            if (a.xd)
                for (var e = 0; e < a.xd.length; e++) A[a.xd[e]] = A[a.xd[e]] || el();
    ...
    var Nm = function(a, b) {},
                    ...
                    e = function(f) {
                        ...
                        if (c.isGtmEvent || Rm(b, n.createOnlyFields)) {
                            ...
                            d && wd(O.M) && (d = !1, m(function() {
                                ...
                                !u || u.get("clientId") == p && q || (c.isGtmEvent ? (n.fieldsToSet["&gcu"] = "1", n.fieldsToSet["&gcut"] = O.Sd[f]) : (n.fieldsToSend["&gcu"] = "1", n.fieldsToSend["&gcut"] = O.Sd[f]), u.set(n.fieldsToSet), c.isGtmEvent ? u.send("pageview") : u.send("pageview", n.fieldsToSend))
                            }));
        ...
        bn = function(a, b, c) {
            ...
            if (na(l)) {
                ...
                var p = function(I) {
                    ...
                    q = function(I) {
                        ...
                        if (L) {
                            ...
                            "promo_view" !== W && "impressions" !== W && (M("ec:addProduct", L.zb), p("ec:setAction", W, L.ib))
                        }
                    },
                    r = function(I) {
                        if (I) {
                            var M = {};
                            if (xb(I))
                                for (var N in Xm) Xm.hasOwnProperty(N) && Ym(Xm[N], N, I[N], M);
                            Tm(M, x);
                            p("require", "linkid", M)
                        }
                    },
                ...
                else b === O.Aa ? (u(), ol(f, c), c.getWithConfig(O.hb) && (dh(["aw", "dc"]), ai(n + ".")), 0 != t.sendPageView && p("send", "pageview", t.fieldsToSend),
            ...
            function c(f) {
                ...
                function l() {
                    if (f.category) m.category = f.category;
                        ...
                        for (var p = "", q = 0; q < dn.length; q++) void 0 !== f[dn[q]] && (p && (p += "/"), p += f[dn[q]]);
                        p && (m.category = p)
                    }
                }
                var m = J(f),
    ...
    var an, Zm = {},
        Pm = {},
        hn = {},
        Km = Object.freeze((hn.client_storage =
            "storage", hn.sample_rate = 1, hn.site_speed_sample_rate = 1, hn.store_gac = 1, hn.use_amp_client_id = 1, hn[O.Ba] = 1, hn[O.qa] = "storeGac", hn[O.ia] = 1, hn[O.ra] = 1, hn[O.Ka] = 1, hn[O.Ib] = 1, hn[O.Za] = 1, hn[O.Jb] = 1, hn)),
        jn = {},
        kn = Object.freeze((jn._cs = 1, jn._useUp = 1, jn.allowAnchor = 1, jn.allowLinker = 1, jn.alwaysSendReferrer = 1, jn.clientId = 1, jn.cookieDomain = 1, jn.cookieExpires = 1, jn.cookieFlags = 1, jn.cookieName = 1, jn.cookiePath = 1, jn.cookieUpdate = 1, jn.legacyCookieDomain = 1, jn.legacyHistoryImport = 1, jn.name = 1, jn.sampleRate = 1, jn.siteSpeedSampleRate =
            1, jn.storage = 1, jn.storeGac = 1, jn.useAmpClientId = 1, jn._cd2l = 1, jn)),
        ln = Object.freeze({
            anonymize_ip: 1
        }),
        mn = {},
        Lm = Object.freeze((mn.campaign = {
            ...
            }, mn.app_id = 1, mn.app_installer_id = 1, mn.app_name = 1, mn.app_version = 1, mn.description = "exDescription", mn.fatal = "exFatal", mn.language = 1, mn.page_hostname = "hostname", mn.transport_type = "transport", mn[O.ca] = "currencyCode", mn[O.Ff] = 1, mn[O.Sa] =
            "location", mn[O.pe] = "page", mn[O.La] = "referrer", mn[O.wc] = "title", mn[O.Nf] = 1, mn[O.Da] = 1, mn)),
        nn = {},
        on = Object.freeze((nn.content_id = 1, nn.event_action = 1, nn.event_category = 1, nn.event_label = 1, nn.link_attribution = 1, nn.name = 1, nn[O.ja] = 1, nn[O.Ef] = 1, nn[O.sa] = 1, nn[O.fa] = 1, nn)),
        pn = Object.freeze({
            displayfeatures: 1,
            enableLinkId: 1,
            enableRecaptcha: 1,
        ...
        qn = {},
        Xm = Object.freeze((qn.levels = 1, qn[O.ra] = "duration", qn[O.Ib] = 1, qn)),
        rn = {},
        sn = Object.freeze((rn.anonymize_ip = 1, rn.fatal = 1, rn.send_page_view = 1, rn.store_gac = 1, rn.use_amp_client_id = 1, rn[O.qa] = 1, rn[O.Ff] = 1, rn)),
        Ym = function(a, b, c, d) {
            if (void 0 !== c)
                if (sn[b] && (c = Aa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Mm(b)] = c;
                else if (k(a)) d[a] = c;
            else
        ...
        tn = {},
        $m = Object.freeze((tn.checkout_progress = 1, tn.select_content = 1, tn.set_checkout_option = 1, tn[O.Eb] = 1, tn[O.Fb] = 1, tn[O.lb] = 1, tn[O.nb] = 1, tn[O.Gb] = 1, tn[O.ma] = 1, tn[O.Hb] = 1, tn[O.na] = 1, tn)),
        un = {},
        vn = Object.freeze((un.checkout_progress = 1, un.set_checkout_option = 1, un[O.tf] = 1, un[O.Eb] = 1, un[O.Fb] = 1, un[O.lb] = 1, un[O.ma] = 1, un[O.Hb] = 1, un[O.uf] = 1, un)),
        wn = {},
        xn = Object.freeze((wn.generate_lead =
            1, wn.login = 1, wn.search = 1, wn.select_content = 1, wn.share = 1, wn.sign_up = 1, wn.view_search_results = 1, wn[O.nb] = 1, wn[O.Gb] = 1, wn[O.na] = 1, wn)),
        yn = function(a) {
            var b = "general";
        ...
        zn = {},
        An = Object.freeze((zn.view_search_results = 1, zn[O.nb] = 1, zn[O.Gb] = 1, zn[O.na] = 1, zn)),
        Um = function(a, b, c) {
        ...
        Qm = function(a, b, c) {
            ...
            for (var r = c.getTopLevelKeys(), u = 0; u < r.length; ++u) {
                ...
                if (c.isGtmEvent) {
                    var v = d(t);
                    pn.hasOwnProperty(t) ?
                        e[t] = v : kn.hasOwnProperty(t) ? l[t] = v : g[t] = v
                } else {
                    var y = void 0;
                    y = t !== O.T ? d(t) : c.getMergedValues(t);
                    if (on.hasOwnProperty(t)) Ym(on[t], t, y, e);
                    else if (ln.hasOwnProperty(t)) Ym(ln[t], t, y, g);
                    else if (Lm.hasOwnProperty(t)) Ym(Lm[t], t, y, f);
                    else if (Km.hasOwnProperty(t)) Ym(Km[t], t, y, l);
                    else if (/^(dimension|metric|content_group)\d+$/.test(t)) Ym(1, t, y, f);
                    else if (t === O.T) {
                        if (!gn) {
                            var x = Na(y);
                            x && (f["&did"] = x)
                        ...
                        w && (f["&gdid"] = w);
                        B && (f["&edid"] = B)
                    } else t === O.Ca && 0 > r.indexOf(O.Ib) && (l.cookieName = y + "_ga")
                }
            ...
            if (c.isGtmEvent) {
                ...
                "login" === b ||
                    "sign_up" === b || "share" === b ? Um(e, "eventLabel", d(O.Ef)) : "search" === b || "view_search_results" === b ? Um(e, "eventLabel", d(O.Oh)) : "select_content" === b && Um(e, "eventLabel", d(O.Bh));
                var C = e[O.ja] || {},
                    D = C[O.Lb];
            ...
            hd() && (g["&gcs"] = xd(), wd(O.M) || (l.storage = "none"), wd(O.D) || (g.allowAdFeatures = !1, l.storeGac = !1));
            var E = d(O.va) || d(O.pb),
                F = d(O.ed);
        ...
        Wm = function(a, b) {
            ...
            if (xb(l))
                for (var m = 0; e && m < e.length; ++m) {
                    var n = e[m],
                        p;
                    for (p in l) l.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != l[p] && Um(n, p, n[l[p]])
                }
            var q = null,
                r = d(O.Gh);
            a === O.ma || a === O.Hb ? q = {
        ...
        On = function(a, b, c, d) {
            if (d.O) {
                ...
                if (f) {
                    ...
                    try {
                        uj(r, u, "1"), Tj(d.type, d.O, v), "config" ===
                            d.type && Uj(d.O);
                        f(d.O, b, d.s, v)
                    } catch (y) {
                        uj(r, u, "4");
    ...
    h.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.m.length;) {
            var f = this.m[0];
            if (f.o) !f.O || Mn(this, f.O).m ? (f.o = !1, this.m.push(f)) : c.push(f), this.m.shift();
            else {
                var g = void 0;
                switch (f.type) {
                    case "require":
                    ...
                    case "config":
                        ...
                        break;
                    case "event":
                        if (g = Mn(this, f.O), g.claimed) break;
                        e.Uc = {};
                        xa(f.m[0], function(r) {
                            return function(u, t) {
                                J(La(u, t), r.Uc)
    ...
    var Rn = !1;
    var Sn = function(a, b) {
        U.addDestinationToContainer ? U.addDestinationToContainer(a, b) : (U.pendingDestinationIds = U.pendingDestinationIds || [], U.pendingDestinationIds.push([a, b]))
    };
    var jo = function(a) {
            var b = U.zones;
            ...
            event: function(a) {
                ...
                if (!(2 > a.length) && k(b)) {
                    ...
                    var d = c,
                        e = {},
                        f = (e.event = b, e);
                    d && (f.eventModel = J(d), d[O.Kb] && (f.eventCallback = d[O.Kb]), d[O.dd] && (f.eventTimeout = d[O.dd]));
                    var g = yo(a);
    ...
    function ep() {
        if (!cp) {
            cp = !0;
            for (var a = 0; a < dp.length; a++) H(dp[a])
        }
    }
    var fp = function(a) {
        cp ? H(a) : dp.push(a)
    ...
    var Gp = function(a) {
            for (var b = wp[String(a)] || [], c = 0; c < b.length; c++) yp.push(b[c]);
            b.length && yp.sort($o);
            delete wp[String(a)]
        },
        Yo = function(a) {
            var b = a.notBeforeEventId;
            vp < b ? (wp[String(b)] = wp[String(b)] || [], wp[String(b)].push(a)) : (yp.push(a), yp.sort($o), H(function() {
                Ap || Fp()
            }))
        };
    var Jp = function() {
    ...
    var mq = A.clearTimeout,
        ...
        tq = function(a, b, c) {
            var d;
            b ? (a.eventCallback = b, c && (a.eventTimeout = c), d = Bp(a)) : d = Bp(a);
            return d
        },
        uq = function(a, b) {
            A[a] = b
    ...
    var Ut = window,
        ...
        Wt = function(a) {
            ...
            if (b && b.ioo && b.ioo() || a && !0 === Ut["ga-disable-" + a]) return !0;
            try {
                var c = Ut.external;
    ...
    Z.g.ua = ["google"],
        function() {
            ...
            (function(m) {
                ...
                var z = function(T, R) {
                    for (var ia in R) R.hasOwnProperty(ia) && (v[T + ia] = R[ia])
                };
                z("contentGroup", p);
                z("dimension", q);
                z("metric", r);
                ...
                if ("TRACK_EVENT" === m.vtp_trackType) x = "track_event", n(), v.eventCategory = String(m.vtp_eventCategory), v.eventAction = String(m.vtp_eventAction), v.eventLabel = c(String, m.vtp_eventLabel), v.value = c(za, m.vtp_eventValue);
                    ...
                    if (x = O.bc, n(), "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == m.vtp_advertisingFeaturesType && (v.remarketingLists = !0), m.vtp_autoLinkDomains) {
                        var C = {};
        ...
        function() {
            ...
            function g(r) {
                if ("form" === r.tagName.toLowerCase() && r.elements) {
                    for (var u = 0, t = 0; t < r.elements.length; t++) Wp(r.elements[t]) && u++;
                    return u
                }
            }
    ...
    Z.g.smm = ["google"],
        function() {
            (function(a) {
                ...
                var b = a.vtp_input,
                    c = lr(a.vtp_map, "key", "value") || {},
                    d = c.hasOwnProperty(b) ? c[b] : a.vtp_defaultValue;
                Aq(d, "smm", a.vtp_gtmEventId);
                return d
            })
        }();
    ...
    (function(a) {
        if (!A["__TAGGY_INSTALLED"]) {
            ...
            b && (A["__TAGGY_INSTALLED"] = !0, gb("https://cct.google/taggy/agent.js"))
        }
        var f = function(q) {
                var r = "GTM",
                    u = "GTM";
                var t = A["google.tagmanager.debugui2.queue"];
                t || (t = [], A["google.tagmanager.debugui2.queue"] = t, gb("https://" + S.Zc + "/debug/bootstrap?id=" + S.H + "&src=" + u + "&cond=" + q + "&gtm=" + mk()));
                var v = {
        ...
        if (b) {
            ...
            for (var g = data.resource || {}, l = g.macros || [], m = 0; m < l.length; m++) Wb.push(l[m]);
            for (var n = g.tags || [], p = 0; p < n.length; p++) Zb.push(n[p]);
            for (var q = g.predicates || [], r = 0; r < q.length; r++) Yb.push(q[r]);
            for (var u = g.rules || [], t = 0; t < u.length; t++) {
                for (var v =
                        u[t], y = {}, x = 0; x < v.length; x++) y[v[x][0]] = Array.prototype.slice.call(v[x], 1);
                Xb.push(y)
            }
            bc = Z;
            cc = cr;
