(function() {
    ...
    */
    ...
    function Ba(a, b, c, d) {
        try {
            ...
            return a.h.l = null, ta(a.h, g), Ca(a)
        }
        a.h.l = null;
        d.call(a.h, f);
        return Ca(a)
    ...
    function Da(a) {
        ...
        this.throw = function(b) {
            sa(a.h);
            a.h.l ? b = Ba(a, a.h.l["throw"], b, a.h.A) : (ta(a.h, b), b = Ca(a));
            return b
        };
    ...
    function Ua(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? Ua = Ra : Ua = Ta;
    ...
    function Lc(a, b) {
        if (null != a) {
            if (Array.isArray(a)) a = Kc(a, b);
            else if (Bc(a)) {
                var c = {},
                    d;
                for (d in a) c[d] = Lc(a[d], b);
                a = c
            } else a = b(a);
            return a
        }
    ...
    function Kc(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = Lc(c[d], b);
    ...
    function Mc(a) {
        ...
        a = Hc(a);
        return Array.isArray(a) ? Ic(a, Mc) : a
    }
    ...
    function Pc(a, b, c, d) {
        Ec(a);
        (c = Qc(a, c)) && c !== b && null != d && (a.h && c in a.h && (a.h[c] = void 0), G(a, c, void 0));
        return G(a, b, d)
    }
    ...
    function Qc(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != Nc(a, e) && (0 !== c && G(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function Yc(a) {
        Cc = !0;
        try {
            return JSON.stringify(a.toJSON(), Zc)
        } finally {
            Cc = !1
        }
    }
        ...
        if (c) {
            ...
            for (var d in c) {
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length)
                            for (f = Sc(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++) $c(f[g], e[g])
                    } else(f = Rc(a, e.constructor, g, void 0, f)) && $c(f, e)
                }
            }
        }
    }
    ...
    if (Fc) {
        var bd = {};
        Object.defineProperties(ad, (bd[Symbol.hasInstance] = Gc(function() {
    ...
    if (Fc) {
        var dd = {};
        Object.defineProperties(I, (dd[Symbol.hasInstance] = Gc(Object[Symbol.hasInstance]), dd))
    };
    var ed = window;
    vb("csi.gstatic.com");
    ...
    */
    ...
    function qd() {
        ...
        function b(q) {
            ...
            for (p = 0; 80 > p; p++) {
                ...
                J = ((q << 5 | q >>> 27) & 4294967295) + J + M + O + v[p] & 4294967295;
                M = F;
                F = y;
        ...
        function c(q, v) {
            if ("string" === typeof q) {
                ...
                for (var p = [], z = 0, y = q.length; z < y; ++z) p.push(q.charCodeAt(z));
                q = p
            }
            v || (v = q.length);
            p = 0;
        ...
        function d() {
            ...
            b(f);
            for (p = v = 0; 5 > p; p++)
                for (var z = 24; 0 <= z; z -= 8) q[v++] = e[p] >> z & 255;
            return q
        }
    ...
    function rd(a, b, c) {
        ...
        return d && a && b ? [b, vd(pd(d), a, c || null)].join(" ") : null
    }
    ...
    function Cd(a) {
        var b = void 0 === b ? !1 : b;
        var c = pd(String(A.location.href)),
            d = [];
        var e = b;
        e = void 0 === e ? !1 : e;
        var f = A.__SAPISID || A.__APISID || A.__3PSAPISID || A.__OVERRIDE_SID;
        Ad(e) && (f = f || A.__1PSAPISID);
        if (f) e = !0;
        else {
            var g = new yd(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            Ad(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new yd(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? rd(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && Ad(b) && ((b = Bd("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = Bd("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, Id[c]) c = Id[c];
                    else {
                        c = String(c);
                        if (!Id[c]) {
                            var f = /function\s+([^\(]+)/m.exec(c);
                            Id[c] = f ? f[1] : "[Anonymous]"
                        }
                        c = Id[c]
                    }
    ...
    Rd.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Sd(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ma = !1)) : (b = new Pd(b, this.src, f, !!d, e), b.ma = c, a.push(b));
        return b
    };
    Rd.prototype.remove = function(a, b, c, d) {
        ...
        b = Sd(e, b, c, d);
        return -1 < b ? (Qd(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.h--), !0) : !1
    };

    function Td(a, b) {
        var c = b.type;
        c in a.listeners && bb(a.listeners[c], b) && (Qd(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }
    ...
    function Xd(a, b, c, d, e) {
        ...
        else c = Zd(c), a && a[Nd] ? a.R(b, c, Na(d) ? !!d.capture : !!d, e) : $d(a, b, c, !1, d, e)
    }
    ...
    function Yd(a, b, c, d, e) {
        ...
        else c = Zd(c), a && a[Nd] ? a.j.add(String(b), c, !0, Na(d) ? !!d.capture : !!d, e) : $d(a, b, c, !0, d, e)
    }

    function ee(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) ee(a, b[f], c, d, e);
        else(d = Na(d) ? !!d.capture : !!d, c = Zd(c), a && a[Nd]) ? a.j.remove(String(b), c, d, e) : a && (a = ae(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Sd(b, c, d, e)), (c = -1 < a ? b[a] : null) && fe(c))
    }
    ...
    function fe(a) {
        if ("number" !== typeof a && a && !a.ha) {
            ...
            if (b && b[Nd]) Td(b.j, a);
                ...
                Wd--;
                (c = ae(b)) ? (Td(c, a), 0 == c.h && (c.src = null, b[Ud] = null)) : Qd(a)
            }
        }
    }
    ...
    function he(a, b) {
        ...
        a = a.wa;
        c = b.type || b;
        "string" === typeof b ? b = new Fd(b, a) : b instanceof Fd ? b.target = b.target || a : (e = b, b = new Fd(c, a), sb(b, e));
        e = !0;
        if (d)
        ...
        b.j || (g = b.h = a, e = ie(g, c, !0, b) && e, b.j || (e = ie(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.j && f < d.length; f++) g = b.h = d[f], e = ie(g, c, !1, b) && e
    }
    ...
    function le(a) {
        a.A = a.J.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return a.h ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.o(3) : w(c, ke(a), 3) : w(c, ke(a), 3);
                le(a);
                c.h = 0
            })
        }, 3E4)
    ...
    function ke(a, b) {
        return a.u ? a.u : a.u = new Promise(function(c) {
            ...
            return x(function(h) {
                switch (h.h) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, ua(h, 2, 3), d && (a.i = a.J.L(function() {
                            d.abort()
                    ...
                    case 3:
                        ...
                        a.u = void 0;
                        a.i && (a.J.Y(a.i), a.i = 0);
                        g !== a.h && (a.h = g, a.h ? he(a, "networkstatus-online") : he(a, "networkstatus-offline"));
                        c(g);
                        ya(h);
                        break;
                    case 2:
    ...
    m.K = function(a) {
        ...
        d.next = function() {
            if (b >= c.length) return Le;
            var e = c[b++];
            if (a) return Me(decodeURIComponent(e.nodeName.replace(/\./g, "%")).substr(1));
            e = e.nodeValue;
            if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered";
            return Me(e)
        };
    ...
    bg.prototype.K = function(a) {
        ...
        d.next = function() {
            ...
            return Me(a ? e.substr(c.h.length) : c.i.get(e))
        };
        return d
    };
    ...
    cg.prototype.W = function() {
        return Nc(this, 2 === Qc(this, dg) ? 2 : -1)
    };
    cg.prototype.setValue = function(a) {
        return Pc(this, 2, dg, a)
    };
    var dg = [2, 3, 4, 5, 6];
    ...
    u(hg, I);
    hg.prototype.getPlayerType = function() {
        return Nc(this, 36)
    };
    hg.prototype.setHomeGroupInfo = function(a) {
        return H(this, 81, a)
    };
    var ig = [9, 66, 24, 32, 86, 100, 101];
    ...
    u(lg, I);
    lg.prototype.setToken = function(a) {
        return G(this, 2, a)
    };
    ...
    u(mg, I);
    mg.prototype.setSafetyMode = function(a) {
        return G(this, 5, a)
    };
    var ng = [12];
    ...
    u(Hg, I);
    Hg.prototype.setVideoId = function(a) {
        return Pc(this, 1, Ig, a)
    };
    Hg.prototype.getPlaylistId = function() {
        return Nc(this, 2 === Qc(this, Ig) ? 2 : -1)
    };
    var Ig = [1, 2];
    ...
    Dd(Og);
    var Pg = A.window,
        Qg, Rg, Sg = (null == Pg ? void 0 : null == (Qg = Pg.yt) ? void 0 : Qg.config_) || (null == Pg ? void 0 : null == (Rg = Pg.ytcfg) ? void 0 : Rg.data_) || {},
        Tg, Ug = (null == Pg ? void 0 : null == (Tg = Pg.ytcfg) ? void 0 : Tg.obfuscatedData_) || [];
    ...
    Dd(Vg);
    var Wg = new Vg(Ug),
        Xg = Sg.EXPERIMENT_FLAGS;
    if (!Xg || !Xg.jspb_i18n_extension) {
        var Yg = new Og;
        Ng.i(Wg, Yg)
    }
    C("yt.config_", Sg);
    ...
    function Zg() {
        var a = arguments;
        1 < a.length ? Sg[a[0]] = a[1] : 1 === a.length && Object.assign(Sg, a[0])
    }

    function N(a, b) {
        return a in Sg ? Sg[a] : b
    }
    ...
    function eh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = N("ERRORS", []), e.push([a, "ERROR", b, c, d]), Zg("ERRORS", e));
        ch(a)
    }

    function fh(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = N("ERRORS", []), e.push([a, "WARNING", b, c, d]), Zg("ERRORS", e))
    };
    var gh = 0;
    ...
    var jh = A.ytEventsEventsCounter || {
        count: 0
    };
    C("ytEventsEventsCounter", jh);
    ...
    function sh(a, b) {
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                var g = th(f[0] || ""),
                    h = th(f[1] || "");
                g in c ? Array.isArray(c[g]) ? fb(c[g], h) : c[g] = [c[g], h] : c[g] = h
            } catch (q) {
                var k = q,
                    l = f[0],
                    n = String(sh);
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: uh == n ? "unchanged" : n
                }];
                rh.hasOwnProperty(l) || fh(k)
            }
        }
        return c
    }
    ...
    function th(a) {
        return a && a.match(qh) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function Ch(a) {
        ...
        try {
            ...
            e.u_his = h;
            var k;
            e.u_h = null == (k = ed.screen) ? void 0 : k.height;
            var l;
            e.u_w = null == (l = ed.screen) ? void 0 : l.width;
            var n;
            e.u_ah = null == (n = ed.screen) ? void 0 : n.availHeight;
            var q;
            e.u_aw =
                null == (q = ed.screen) ? void 0 : q.availWidth;
            var v;
            e.u_cd = null == (v = ed.screen) ? void 0 : v.colorDepth
        } catch (ka) {}
        h = b.h;
        try {
            var p = h.screenX;
        ...
        try {
            ...
            var Be = h.screen.availTop
        } catch (ka) {}
        p = [O, cb, p, z, ic, Be, y, F, M, J];
        z = b.h.top;
        try {
            var Z = (z || window).document,
                S =
                "CSS1Compat" == Z.compatMode ? Z.documentElement : Z.body;
            var U = (new fd(S.clientWidth, S.clientHeight)).round()
        } catch (ka) {
            U = new fd(-12245933, -12245933)
        }
        Z = U;
        U = {};
        var V = void 0 === V ? A : V;
        ...
        b = (U.vis = b.prerendering ?
            3 : {
                ...
                preview: 4,
                unloaded: 5
            }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, U.wgl = !!ed.WebGLRenderingContext, U);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var Eh = "XMLHttpRequest" in A ? function() {
    ...
    function Jh(a, b) {
        ...
        for (e in Gh) {
            var f = N(Gh[e]);
            !f || !c && Lb(a) || d && void 0 !== b[e] || !P("enable_web_eom_visitor_data") && "X-Goog-EOM-Visitor-Id" === e || (b[e] = f)
        }
        ...
        if (c ||
            !Lb(a)) b["X-YouTube-Ad-Signals"] = vh(Ch(void 0));
        return b
    }
    ...
    function Kh(a) {
        var b = window.location.search,
            c = Lb(a);
        P("debug_handle_relative_url_for_query_forward_killswitch") || c || !yh(a) || (c = document.location.hostname);
        ...
        var d = Nh(a, b),
            ...
            f = Oh(a, function(k) {
                if (!e) {
                    ...
                    if (l || q || v) n = Ph(a, c, k, b.convertToSafeHtml);
    ...
    function Mh(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = xh(a, b || {}, !0);
        return a
    }
    ...
    function Nh(a, b) {
        ...
        f && "string" === typeof e && (e = wh(e), sb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Ob(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!Ih && a && "POST" != b.method && (Ih = !0, eh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, fh(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? Qh(a) : null) e = {}, D(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = Rh(g)
                })
        }
        d && Sh(e);
    ...
    function Oh(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && dh(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = Fh();
        ...
        P("debug_forward_web_query_parameters") && (a = Kh(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function ai() {
        return "INNERTUBE_API_KEY" in Sg && "INNERTUBE_API_VERSION" in Sg
    }
    ...
    function ci(a) {
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = t(Object.entries(wh(N("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = t(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function ii(a) {
        ...
        gi(a, c);
        hi(c);
        N("DELEGATED_SESSION_ID") && !P("pageid_as_header_web") && (a = new mg, G(a, 3, N("DELEGATED_SESSION_ID")));
        a = t(Object.entries(wh(N("DEVICE", ""))));
    ...
    function di(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                ...
                null !== d && G(c, 3, d);
                H(b, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = Uh())
    }
    ...
    function hi(a, b) {
        a: {
            var c = $h();
            if (c) {
                var d = Wh[c.type || "unknown"] || "CONN_UNKNOWN";
                c = Wh[c.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        d && (a ? G(a, 61, Xh[d]) : b && (b.client.connectionType = d));P("web_log_effective_connection_type") && (d = $h(), d = null != d && d.effectiveType ? Zh.hasOwnProperty(d.effectiveType) ? Zh[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d && (a ? G(a, 94, Yh[d]) :
    ...
    function ji(a, b, c) {
        ...
        (b = c.Mb || N("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().Lb : b = Cd([]));
    ...
    li.prototype.get = function(a, b) {
        ...
        if (d && (c = zd.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    var mi = window,
        Q = mi.ytcsi && mi.ytcsi.now ? mi.ytcsi.now : mi.performance && mi.performance.timing && mi.performance.now && mi.performance.timing.navigationStart ? function() {
            return mi.performance.timing.navigationStart + mi.performance.now()
        } : function() {
    ...
    function pi(a, b, c, d) {
        ...
        oi().set("nextId", d + 1, 86400, !0);
        oi().set("requests", e, 86400, !0);
        return d
    }

    function qi(a) {
        var b = oi().get("requests", !0) || {};
        delete b[a];
        oi().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(Q()) - d.requestTime)) {
                    var e = d.authState,
                        f = ki(ji(!1));
                    pb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(Q())), si(a, d.method, e, {}));
                    delete b[c]
                }
            }
            oi().set("requests", b, 86400, !0)
    ...
    function vi(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : oh(a, c || 0)
    }
    xi.prototype.Y = function(a) {
    ...
    function Bi() {
        var a;
        return null == (a = Ai()) ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    };
    var Ci = [],
        Di = !1;
    ...
    function Ii() {
        ...
        throw new Gi("Datasync ID not set", "unknown");
    };
    ...
    var Li = {},
        Mi = (Li.AUTH_INVALID = "No user identifier specified.", Li.EXPLICIT_ABORT = "Transaction was explicitly aborted.", Li.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", Li.MISSING_INDEX = "Index not created.", Li.MISSING_OBJECT_STORES = "Object stores not created.", Li.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.", Li.DB_REOPENED_BY_MISSING_OBJECT_STORES = "Database is reopened because expected object stores were not created.", Li.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
            Li.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", Li.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", Li.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", Li.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", Li),
        Ni = {},
        Oi = (Ni.AUTH_INVALID = "ERROR", Ni.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", Ni.EXPLICIT_ABORT = "IGNORED", Ni.IDB_NOT_SUPPORTED = "ERROR", Ni.MISSING_INDEX =
            "WARNING", Ni.MISSING_OBJECT_STORES = "ERROR", Ni.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING", Ni.DB_REOPENED_BY_MISSING_OBJECT_STORES = "WARNING", Ni.QUOTA_EXCEEDED = "WARNING", Ni.QUOTA_MAYBE_EXCEEDED = "WARNING", Ni.UNKNOWN_ABORT = "WARNING", Ni.INCOMPATIBLE_DB_VERSION = "WARNING", Ni),
        Pi = {},
        Qi = (Pi.AUTH_INVALID = !1, Pi.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, Pi.EXPLICIT_ABORT = !1, Pi.IDB_NOT_SUPPORTED = !1, Pi.MISSING_INDEX = !1, Pi.MISSING_OBJECT_STORES = !1, Pi.DB_DELETED_BY_MISSING_OBJECT_STORES = !1, Pi.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1, Pi.QUOTA_EXCEEDED = !1, Pi.QUOTA_MAYBE_EXCEEDED = !0, Pi.UNKNOWN_ABORT = !0, Pi.INCOMPATIBLE_DB_VERSION = !1, Pi);
    ...
    u(Si, Error);
    var Ti = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function Ui(a, b, c, d) {
        ...
        if (e instanceof Si) return new T("MISSING_INDEX", Object.assign({}, a, {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && Ti.some(function(f) {
    ...
    W.all = function(a) {
        return new W(new Yi(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    Z: f.Z
                }, ++f.Z) Zi(W.resolve(a[f.Z]).then(function(g) {
                return function(h) {
                    d[g.Z] = h;
                    e--;
                    0 === e && b(d)
    ...
    W.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : Xi,
            e = null != b ? b : Wi;
        return new W(new Yi(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                $i(c, c, d, f, g)
            }), c.onRejected.push(function() {
                aj(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? $i(c, c, d, f, g) : "REJECTED" === c.state.status && aj(c, c, e, f, g)
        }))
    };
    ...
    function $i(a, b, c, d, e) {
        try {
            ...
            f instanceof W ? bj(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function ej(a, b) {
        return new W(new Yi(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
        ...
        return x(function(F) {
            switch (F.h) {
                ...
                case 2:
                    ...
                    return w(F, M, 6);
                case 6:
                    return n = F.i, q = Math.round(Q()), mj(a, k, q, g, void 0, b.join(), e), F.return(n);
                case 4:
                    v = wa(F);
                    p = Math.round(Q());
                    z = Ui(v, a.h.name, b.join(), a.h.version);
                    if ((y = z instanceof T && !z.h) || g >= f) mj(a, k, p, g, z, b.join(), e), h = z;
                    F.o(2);
                    break;
                case 3:
    ...
    function mj(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof T && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && Fi("QUOTA_EXCEEDED", {
            dbName: Ki(a.h.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), Fi("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.i = !0), nj(a, !1, d, f, b, g.tag), Ei(e)) : nj(a, !0, d, f, b, g.tag)
    }
    ...
    m.delete = function(a) {
        return a instanceof IDBKeyRange ? oj(this, a) : X(this.h.delete(a))
    };
    m.get = function(a) {
    ...
    m.index = function(a) {
        try {
            return new qj(this.h.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new Si(a, this.h.name);
            throw b;
        }
    };
    m.getName = function() {
    ...
    kj.prototype.objectStore = function(a) {
        a = this.h.objectStore(a);
        var b = this.j.get(a);
        b || (b = new ij(a), this.j.set(a, b));
        return b
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(p) {
                try {
                    ...
                    p.dataLoss && "none" !== p.dataLoss && Fi("IDB_DATA_CORRUPTED", {
                        reason: p.dataLossMessage || "unknown reason",
                        dbName: Ki(a)
                    });
                    var z = f(),
                        y = new kj(g.transaction);
                    n && n(z, function(F) {
    ...
    function lk(a, b) {
        ...
        var c, d, e, f;
        return x(function(g) {
            if (1 == g.h) return ua(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.blocked) && c.addEventListener("blocked", function() {
                e()
            }), w(g, dj(c), 4);
            if (2 != g.h) return va(g, 0);
            f = wa(g);
            throw Ui(f, a, "", -1);
        })
    };
    ...
    function pk(a, b) {
        if (!b) throw Vi("openWithToken", Ki(a.name));
        return a.open()
    }
    nk.prototype.open = function() {
        function a() {
            var f, g, h, k, l, n, q, v, p, z;
            return x(function(y) {
                switch (y.h) {
                    case 1:
                        return g = null != (f = Error().stack) ? f : "", ua(y, 2), w(y, c.j(c.name, c.options.version, e), 4);
                    case 4:
                        h = y.i;
                        for (var F = c.options, M = [], J = t(Object.keys(F.ga)), O = J.next(); !O.done; O = J.next()) {
                            O = O.value;
                            var cb = F.ga[O],
                                ic = void 0 === cb.rb ? Number.MAX_VALUE : cb.rb;
                            !(h.h.version >= cb.xa) || h.h.version >= ic || h.h.objectStoreNames.contains(O) || M.push(O)
                        }
                        k = M;
                        if (0 === k.length) {
                            y.o(5);
                        ...
                        if (!(c.m < Ah("ytidb_remake_db_retries", 1))) {
                            y.o(6);
                            break
                        }
                        c.m++;
                    ...
                    case 9:
                        return Ei(new T("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: c.name,
                            expectedObjectStores: l,
                            foundObjectStores: n
                        })), y.return(a());
                    ...
                    case 2:
                        ...
                        return w(y, c.j(c.name, void 0, Object.assign({}, e, {
                            upgrade: void 0
                        })), 11);
                    case 11:
                        v = y.i;
    ...
    function rk(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return w(d, pk(qk, b), 2);
            c = d.i;
            return d.return(gj(c, ["databases"], {
                H: !0,
                mode: "readwrite"
            }, function(e) {
    ...
    function sk(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return a ? w(d, pk(qk, b), 2) : d.return();
            c = d.i;
    ...
    function tk(a, b) {
        var c, d;
        return x(function(e) {
            return 1 == e.h ? (c = [], w(e, pk(qk, b), 2)) : 3 != e.h ? (d = e.i, w(e, gj(d, ["databases"], {
                H: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return pj(f.objectStore("databases"), {}, function(g) {
                    a(g.W()) && c.push(g.W());
                    return g.continue()
                })
            }), 3)) : e.return(c)
        ...
        return x(function(e) {
            switch (e.h) {
                case 1:
                    ...
                    var f;
                    if (f = zi) f = /WebKit\/([0-9]+)/.exec(Fb()), f = !!(f && 600 <= parseInt(f[1], 10));
                    f && (f = /WebKit\/([0-9]+)/.exec(Fb()), f = !(f && 602 <= parseInt(f[1], 10)));
                    if (f || Zb) return e.return(!1);
                    try {
                    ...
                    return w(e, rk(d, wk), 4);
                case 4:
                    return w(e, sk("yt-idb-test-do-not-use", wk), 5);
                case 5:
                    return e.return(!0);
                case 2:
    ...
    function yk() {
        if (void 0 !== vk) return vk;
        Di = !0;
        return vk = xk().then(function(a) {
            Di = !1;
            var b;
            if (null != (b = Ai()) && b.h) {
                var c;
                b = {
                    hasSucceededOnce: (null == (c = Bi()) ? void 0 : c.hasSucceededOnce) || a
                };
                var d;
                null == (d = Ai()) || d.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0)
            }
            return a
        })
    }
    ...
    function Ak() {
        var a = zk();
        return a ? Promise.resolve(a) : yk().then(function(b) {
            (b = b ? wk : void 0) && C("ytglobal.idbToken_", b);
            return b
        })
    };
    new Xe;
    ...
    function Bk(a) {
        if (!Hi()) throw a = new T("AUTH_INVALID", {
            dbName: a
        }), Ei(a), a;
        var b = Ii();
        return {
    ...
    function Ck(a, b, c, d) {
        ...
        return x(function(n) {
            switch (n.h) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", w(n, Ak(), 2);
                case 2:
                    g = n.i;
                    if (!g) throw h = Vi("openDbImpl", a, b), P("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), Ei(h), h;
                    Ji(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                    ...
                    return w(n, rk(k, g), 5);
                case 5:
                    return w(n, kk(k.actualName, b, d), 6);
                case 6:
                    return n.return(n.i);
                case 3:
                    return l = wa(n), ua(n, 7), w(n, sk(k.actualName, g), 9);
                case 9:
                    va(n,
                        8);
                    break;
    ...
    function Fk(a, b) {
        ...
        return x(function(e) {
            ...
            return w(e, sk(d.actualName, c), 0)
        })
    }
    ...
    function Gk(a, b, c) {
        a = a.map(function(d) {
            return x(function(e) {
                return 1 == e.h ? w(e, lk(d.actualName, b), 2) : w(e, sk(d.actualName, c), 0)
            })
        });
    ...
    function Jk(a) {
        ...
        this.ea = !1;
        var b;
        this.Za = null != (b = a.Za) ? b : 100;
        var c;
        this.Ya = null != (c = a.Ya) ? c : 1;
        var d;
        this.Wa = null != (d = a.Wa) ? d : 2592E6;
        var e;
        this.Va = null != (e = a.Va) ? e : 12E4;
        var f;
        this.Xa = null != (f = a.Xa) ? f : 5E3;
        var g;
    ...
    function Kk(a) {
        a.s && !a.ea && (a.h = !0, a.pa && Math.random() <= a.oa && a.D.hb(a.s), Lk(a), a.G.F() && a.ja(), a.G.R(a.Ea, a.ja.bind(a)), a.G.R(a.Da, a.Ia.bind(a)))
    }
    m = Jk.prototype;
    ...
    function Ok(a, b, c, d) {
        ...
        if (a.s && a.h) {
            ...
            a.B && a.B("nwl_skip_retry") && (e.skipRetry = d);
            if (a.G.F() || a.B && a.B("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = c.onError ? c.onError : function() {};
                    c.onError = function(g, h) {
                        return x(function(k) {
                            if (1 == k.h) return w(k, a.D.set(e, a.s).catch(function(l) {
                                Nk(a, l)
                            }), 2);
                            f(g, h);
                            k.h = 0
                ...
                a.T(b, c, e.skipRetry)
            } else a.D.set(e, a.s).catch(function(g) {
                a.T(b, c, e.skipRetry);
                Nk(a, g)
            })
        } else a.T(b, c, a.B && a.B("nwl_skip_retry") && d)
    }
    ...
    m.ja = function() {
        var a = this;
        if (!this.s) throw Vi("throttleSend");
        this.i || (this.i = this.J.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return w(c, a.D.Na("NEW", a.s), 2);
                if (3 != c.h) return b = c.i, b ? w(c, Mk(a, b), 3) : (a.Ia(), c.return());
                a.i && (a.i = 0, a.ja());
                c.h = 0
            })
        }, this.Za))
    ...
    function Mk(a, b) {
        ...
        return x(function(e) {
            switch (e.h) {
                case 1:
                    if (!a.s) throw c = Vi("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.o(2);
                        break
                    }
    ...
    function Qk(a, b) {
        if (!a.s) throw Vi("updateRequestHandlers");
            ...
            return x(function(l) {
                switch (l.h) {
                    ...
                    case 3:
                        ...
                        return w(l, a.D.Fa(b.id, a.s, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        ...
                        return b.sendCount < a.Ya ? w(l, a.D.Fa(b.id, a.s), 12) : w(l, a.D.aa(b.id, a.s), 8);
                    case 12:
                        a.J.L(function() {
                            a.G.F() && a.ja()
                        }, a.Xa);
    ...
    function Lk(a) {
        if (!a.s) throw Vi("retryQueuedRequests");
        a.D.Na("QUEUED", a.s).then(function(b) {
            b && !Pk(a, b, a.Va) ? a.J.L(function() {
                return x(function(c) {
    ...
    var Sk = B("ytPubsub2Pubsub2Instance") || new L;
    ...
    Tk.prototype.j = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ga ? Ek : Dk)(a, b, Object.assign({}, c))
    };
    Tk.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ga ? Ik : Fk)(this.name, a)
    };
    ...
    function Xk() {
        if (Wk) return Wk();
        var a = {};
        Wk = Vk("LogsDatabaseV2", {
            ga: (a.LogsRequestsStore = {
                xa: 2
            }, a),
            Ga: !1,
            upgrade: function(b, c, d) {
                c(2) && hj(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
    ...
    function al(a, b) {
        ...
        return x(function(l) {
            ...
            if (3 != l.h) return d = l.i, e = N("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, Q()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, gj(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    H: !0
                }, function(n) {
                    return sj(n.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(q) {
    ...
    function bl(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.h) return w(d, Yk(b), 2);
            c = d.i;
            return d.return(gj(c, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
    ...
    function cl(a, b, c) {
        ...
        var d;
        return x(function(e) {
            if (1 == e.h) return w(e, Yk(b), 2);
            d = e.i;
            return e.return(gj(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(f) {
    ...
    function el(a) {
        var b, c;
        return x(function(d) {
            if (1 == d.h) return w(d, Yk(a), 2);
            b = d.i;
            c = Q() - 2592E6;
            return w(d, gj(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
                return pj(e.objectStore("LogsRequestsStore"), {}, function(f) {
    ...
    var gl = {},
        hl = Vk("ServiceWorkerLogsDatabase", {
            ga: (gl.SWHealthLog = {
                xa: 1
            }, gl),
            Ga: !0,
            upgrade: function(a, b) {
                b(1) && hj(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function jl(a) {
        var b, c;
        x(function(d) {
            if (1 == d.h) return w(d, il(a), 2);
            b = d.i;
            c = Q() - 2592E6;
            return w(d, gj(b, ["SWHealthLog"], {
                mode: "readwrite",
                H: !0
            }, function(e) {
                return pj(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.W().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
    ...
    function nl(a) {
        var b = void 0 === b ? "" : b;
        if (a)
            if (b) Oh(a, void 0, "POST", b, void 0);
            else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) Oh(a, void 0, "GET", "", void 0);
        else {
            b: {
                try {
                    var c = new Ya({
    ...
    function ql() {
        if (!pl.h) {
            var a = B("yt.networkRequestMonitor.instance") || new pl;
            C("yt.networkRequestMonitor.instance", a);
            pl.h = a
        }
        return pl.h
    }
    pl.prototype.requestComplete = function(a, b) {
        b && (this.i = !0);
        a = this.removeParams(a);
        this.h.get(a) || this.h.set(a, b)
    };
    pl.prototype.isEndpointCFR = function(a) {
        a = this.removeParams(a);
        return (a = this.h.get(a)) ? !1 : !1 === a && this.i ? !0 : null
    };
    pl.prototype.removeParams = function(a) {
        return a.split("?")[0]
    };
    pl.prototype.removeParams = pl.prototype.removeParams;
    pl.prototype.isEndpointCFR = pl.prototype.isEndpointCFR;
    pl.prototype.requestComplete = pl.prototype.requestComplete;
    pl.getInstance = ql;
    var rl;

    function sl() {
        rl || (rl = new li("yt.offline"));
        return rl
    }
    ...
    function ul() {
        if (P("offline_error_handling")) {
            ...
            if (a) {
                for (var b in a)
                    if (a[b]) {
                        var c = new Gi(b, "sent via offline_errors");
                        c.name = a[b].name;
                        c.stack = a[b].stack;
                        c.level = a[b].level;
                        eh(c)
    ...
    var vl = Ah("network_polling_interval", 3E4);
    ...
    function Y() {
        ...
        this.A = this.m = !1;
        this.i = this.ya();
        P("use_shared_nsm") ? (this.h = me(), P("use_shared_nsm_and_keep_yt_online_updated") && (this.h.R("networkstatus-online", function() {
            a.i = !0;
            a.A && ul()
    ...
    m.qb = function(a) {
        !P("use_shared_nsm") && (this.m = !0, void 0 === a ? 0 : a) && (this.la || zl(this))
    };
    m.ya = function() {
    ...
    m.U = function(a) {
        ...
        if (P("use_shared_nsm") && this.h) {
            var c = ke(this.h, a);
            c.then(function(d) {
                P("use_cfr_monitor") && ql().requestComplete("generate_204", d)
            });
            return c
        }
        return this.u ? this.u : this.u = new Promise(function(d) {
            ...
            return x(function(k) {
                switch (k.h) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, ua(k, 2, 3), e && (b.O = ne.L(function() {
                            e.abort()
                    ...
                    case 3:
                        xa(k);
                        P("use_cfr_monitor") && ql().requestComplete("generate_204", h);
                        b.u = void 0;
                        b.O && ne.Y(b.O);
                        h !== b.i && (b.i = h, b.i && b.m ? he(b, "ytnetworkstatus-online") : b.m && he(b, "ytnetworkstatus-offline"));
                        d(h);
                        ya(k);
                        break;
                    case 2:
    ...
    Y.prototype.getWindowStatus = Y.prototype.ya;
    ...
    function Al(a) {
        ...
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.h)) a.va ? (this.va = a.va, c(this.u,
            function() {
                Bl(b, "publicytnetworkstatus-online")
            }), c(this.m, function() {
            Bl(b, "publicytnetworkstatus-offline")
        })) : (c(this.u, function() {
            he(b, "publicytnetworkstatus-online")
        }), c(this.m, function() {
            he(b, "publicytnetworkstatus-offline")
        }))
    }
    u(Al, K);
    ...
    Al.prototype.U = function(a) {
        var b = this,
            c;
        return x(function(d) {
            c = B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.h);
            return P("skip_network_check_if_cfr") && ql().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
    ...
    function Bl(a, b) {
        a.va ? a.i ? (ne.Y(a.O), a.O = ne.L(function() {
            a.A !== b && (he(a, b), a.A = b, a.i = Q())
        }, a.va - (Q() - a.i))) : (he(a, b), a.A = b, a.i = Q()) : he(a, b)
    };
    var Cl;
    ...
    function Dl() {
        Jk.call(this, {
            ...
            pa: !0,
            oa: .1,
            ta: Ah("potential_esf_error_limit", 10),
            B: P,
            ea: !(Hi() && (P("embeds_web_nwl_disable_nocookie") ? "www.youtube-nocookie.com" !== Lb(document.location.toString()) : 1))
        });
        this.j = new Xe;
        P("networkless_immediately_drop_all_requests") && fl();
        Ik("LogsDatabaseV2")
    }
    u(Dl, Jk);
    ...
    function Gl() {
        ...
        a || (a = new Dl, C("yt.networklessRequestController.instance", a), P("networkless_logging") && Ak().then(function(b) {
            a.s = b;
            Kk(a);
            a.j.resolve();
            a.pa && Math.random() <= a.oa && a.s && jl(a.s);
            P("networkless_immediately_drop_sw_health_store") && Hl(a)
        }));
        return a
    }
    Dl.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        Hi() || (this.h = !1);
        Jk.prototype.writeThenSend.call(this, a, b)
    };
    Dl.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        Hi() || (this.h = !1);
        Jk.prototype.sendThenWrite.call(this, a, b, c)
    };
    Dl.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        Hi() || (this.h = !1);
        Jk.prototype.sendAndWrite.call(this, a, b)
    };
    Dl.prototype.awaitInitialization = function() {
    ...
    function Hl(a) {
        var b;
        x(function(c) {
            if (!a.s) throw b = Vi("clearSWHealthLogsDb"), b;
            return c.return(kl(a.s).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    var Jl = 0,
        Kl = 0,
        Ll, Ml = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
            potentialEsfErrorCounter: Kl
        };
    C("ytNetworklessLoggingInitializationOptions", Ml);

    function Nl(a, b) {
        function c(d) {
            var e = Ol().F();
            if (!Pl() || !d || e && P("vss_networkless_bypass_write")) Ql(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        P("skip_is_supported_killswitch") ? Ak().then(function(d) {
            c(d)
        }) : c(zk())
    }
        ...
        function c(d) {
            if (Pl() && d) {
                ...
                e.options.onSuccess = function(k, l) {
                    P("use_cfr_monitor") && ql().requestComplete(e.url, !0);
                    void 0 !== e.id ? dl(e.id, d) : f = !0;
                    P("vss_network_hint") && Ol().S(!0);
                    g(k, l)
                };
    ...
    function Tl() {
        var a = zk();
        if (!a) throw Vi("throttleSend");
        Jl || (Jl = ne.L(function() {
            var b;
            return x(function(c) {
                if (1 == c.h) return w(c, al("NEW", a), 2);
                if (3 != c.h) return b = c.i, b ? w(c, Rl(b), 3) : (ne.Y(Jl), Jl = 0, c.return());
                Jl && (Jl = 0, Tl());
                c.h = 0
            })
        }, 100))
    ...
    function Rl(a) {
        ...
        return x(function(e) {
            switch (e.h) {
                case 1:
                    b = zk();
                    if (!b) throw c = Vi("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.o(2);
                        break
                    }
                    return w(e, bl(a.id, b), 3);
                case 3:
                    (d = e.i) ? a = d: fh(Error("The request cannot be found in the database."));
                case 2:
                    var f = a.timestamp;
                    if (!(2592E6 <= Q() - f)) {
                        e.o(4);
                    ...
                    fh(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.o(5);
                        break
                    }
                    return w(e, dl(a.id, b), 5);
                case 5:
                    return e.return();
                case 4:
                    a.skipRetry || (a = Ul(a));
                    ...
                    return w(e, dl(a.id, b), 8);
                case 8:
                    Ql(a.url, a.options, !!a.skipRetry), e.h = 0
            }
        })
    }
    ...
    function Ul(a) {
        var b = zk();
        if (!b) throw Vi("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return x(function(l) {
                switch (l.h) {
                    case 1:
                        P("use_cfr_monitor") && ql().requestComplete(a.url, !1);
                        g = Rk(f);
                        if (!(P("nwl_consider_error_code") && g || !P("nwl_consider_error_code") && Vl() <= Ah("potential_esf_error_limit", 10))) {
                            l.o(2);
                            break
                        }
                        if (P("skip_checking_network_on_cfr_failure") && (!P("skip_checking_network_on_cfr_failure") || ql().isEndpointCFR(a.url))) {
                            l.o(3);
                            break
                        }
                        return w(l, Ol().U(), 3);
                    case 3:
                        ...
                        return w(l, cl(a.id, b, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        if (P("nwl_consider_error_code") && !g && Vl() > Ah("potential_esf_error_limit", 10)) return l.return();
                        B("ytNetworklessLoggingInitializationOptions") && Ml.potentialEsfErrorCounter++;
                        Kl++;
                        if (void 0 === (null == (k = a) ? void 0 : k.id)) {
                            l.o(8);
                            break
                        }
                        return 1 > a.sendCount ? w(l, cl(a.id, b), 12) : w(l, dl(a.id, b), 8);
                    case 12:
                        ne.L(function() {
                            Ol().F() && Tl()
                        }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            var g;
            return x(function(h) {
                if (1 == h.h) return P("use_cfr_monitor") && ql().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.o(2) : w(h, dl(a.id, b), 2);
                P("vss_network_hint") && Ol().S(!0);
                d(e, f);
                h.h = 0
            })
    ...
    function Pl() {
        return B("ytNetworklessLoggingInitializationOptions") ? Ml.isNwlInitialized : !1
    }

    function Vl() {
        return B("ytNetworklessLoggingInitializationOptions") ? Ml.potentialEsfErrorCounter : Kl
    };
    ...
    function si(a, b, c, d) {
        function e(z) {
            z = void 0 === z ? !1 : z;
            var y;
            if (d.retry && "www.youtube-nocookie.com" != h && (z || P("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (y = pi(b, c, l, k)), y)) {
                var F = g.onSuccess,
                    M = g.onFetchSuccess;
            ...
            try {
                z && d.retry && !d.Ta.bypassNetworkless ? (g.method = "POST", d.Ta.writeThenSend ? P("use_new_nwl_wts") ? Gl().writeThenSend(p, g) : Nl(p, g) : P("use_new_nwl_saw") ? Gl().sendAndWrite(p, g) : Sl(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), Lh(p, g))
            } catch (J) {
                if ("InvalidAccessError" == J.name) y && (qi(y), y = 0), fh(Error("An extension is blocking network request."));
                else throw J;
            }
            y && ui(function() {
                ri(a)
            }, 5E3)
        }!N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && fh(new Gi("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        var p = xh("" + h + n, q || {}, !0);
        P("use_new_nwl") && Gl().h || !P("use_new_nwl") &&
            Pl() ? yk().then(function(z) {
                e(z)
            }) : e(!1)
    };
    var Xl = {
    ...
    var $l = A.ytPubsubPubsubInstance || new L,
    ...
    var hm = new gm,
        im = new gm,
        jm = !0,
        km = A.ytLoggingTransportGELQueue_ || new Map;
    C("ytLoggingTransportGELQueue_", km);
    var lm = A.ytLoggingTransportGELProtoQueue_ || new Map;
    C("ytLoggingTransportGELProtoQueue_", lm);
    var mm = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    C("ytLoggingTransportTokensToCttTargetIds_", mm);
    var nm = A.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    C("ytLoggingTransportTokensToJspbCttTargetIds_", nm);
    ...
    function qm(a, b, c, d) {
        d = void 0 === d ? !1 : d;
        a && (fm = new a);
        a = Ah("tvhtml5_logging_max_batch") || Ah("web_logging_max_batch") || 100;
        var e = Q(),
            f = d ? im.j : hm.j;
        b.length >= a ? sm({
            writeThenSend: !0
        }, P("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && (tm(d), d ? im.j = e : hm.j = e)
    }
    ...
    function wm(a, b) {
        if ("log_event" === a.endpoint) {
            var c = pm(a, !0),
                d = new Map;
            d.set(c, [Yc(a.payload)]);
            b && (fm = new b);
            return new Ye(function(e) {
                fm && fm.isReady() ? xm(d, e, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function pm(a, b) {
        ...
        if (a.da) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.P;
                var d = new Hg;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && Pc(d, 2, Ig, c.playlistId);
                nm[b] = d
            } else b = a.P, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), mm[a.P.token] = c;
            c = a.P.token
        }
        return c
    }
    ...
    function sm(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new Ye(function(d) {
            c ? (window.clearTimeout(im.i), window.clearTimeout(im.h), im.h = 0) : (window.clearTimeout(hm.i), window.clearTimeout(hm.h), hm.h = 0);
            if (fm && fm.isReady())
                if (void 0 !== b)
                    if (c) {
                        var e = new Map,
                        ...
                        xm(e, d, a);
                        lm.delete(b)
                    } else e = new Map, f = km.get(b) || [], e.set(b, f), vm(e, d, a), km.delete(b);
            else c ? (xm(lm, d, a), lm.clear()) : (vm(km, d, a), km.clear());
            else tm(c), d()
        })
    }
    ...
    function tm(a) {
        a = void 0 === a ? !1 : a;
        if (P("web_gel_timeout_cap") && (!a && !hm.h || a && !im.h)) {
            var b = oh(function() {
                sm({
                    writeThenSend: !0
                }, void 0, a)
        ...
        window.clearTimeout(a ? im.i : hm.i);
        b = N("LOGGING_BATCH_TIMEOUT", Ah("web_gel_debounce_ms", 1E4));
        P("shorten_initial_gel_batch_timeout") && jm && (b = dm);
        b = oh(function() {
            sm({
                writeThenSend: !0
            }, void 0, a)
    ...
    function vm(a, b, c, d) {
        ...
        for (var h = a.next(); !h.done; h = a.next()) {
            ...
            zm(k, f, h);
            Am(c);
            si(e, "log_event", k, Bm(c, h, function() {
                g--;
                g || b()
            }, function() {
                g--;
    ...
    function xm(a, b, c, d) {
        ...
        for (var h = a.next(); !h.done; h = a.next()) {
            ...
            var l = k = k.next().value;
            k = new Jg;
            var n = ii(e.config_ || bi());
            H(k, 1, n);
            l = Cm(l);
            for (n = 0; n < l.length; n++) Uc(k, 3, Eg, l[n]);
            (l = nm[h]) && Dm(k, h, l);
            delete nm[h];
            h = "visitorOnlyApprovedKey" === h;
            Em(k, f, h);
    ...
    function zm(a, b, c) {
        ...
        !c && (b = N("EVENT_ID", void 0)) && (c = Fm(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function Cm(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            if (null == f || "" == f) var h = new g;
                ...
                var k = JSON.parse(f);
                if (!Array.isArray(k)) throw Error("Expected to deserialize an Array but got " + La(k) + ": " + k);
                Xc = k;
                var l = new g(k);
                Xc = null;
                h = l
            ...
            eh(new Gi("Transport failed to deserialize " + String(a[c])))
        }
        return b
    };
    var Gm = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", Gm);

    function Hm(a) {
        Gm[a] = a in Gm ? Gm[a] + 1 : 0;
        return Gm[a]
    };
    ...
    function Im(a, b) {
        var c = void 0 === c ? {} : c;
        var d = Wl;
        N("ytLoggingEventsDefaultDisabled", !1) && Wl == Wl && (d = null);
        a: {
            c = void 0 === c ? {} : c;
            if (P("lr_drop_other_and_business_payloads")) {
                if (Yl[a] || Xl[a]) break a
            } else if (P("lr_drop_other_payloads") && Yl[a]) break a;
            var e = {},
                f = Math.round(c.timestamp || Q());e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0;e[a] = b;a = Zl();e.context = {
                lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a)
            };P("log_sequence_info_on_gel_web") && c.ia && (a = e.context, b = c.ia, b = {
                    index: Hm(b),
                    groupKey: b
                }, a.sequence =
                b, c.kb && delete Gm[c.ia]);
            (c.sb ? um : om)({
                endpoint: "log_event",
                payload: e,
                P: c.P,
    ...
    function Om() {
        if (!Nm) {
            ...
            a.X.length = 0;
            a.V.length = 0;
            Lm.X && a.X.push.apply(a.X, Lm.X);
            Lm.V && a.V.push.apply(a.V, Lm.V)
        }
        return Nm
    };
    var Pm = new L;
    ...
    function Sm(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Tm(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Qm(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Tm(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += Tm(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = Um(a), d += c[b].length;
        else c[b] = Um(a), d += c[b].length;
        return d
    }
    ...
    var Vm = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", Vm);

    function Wm(a) {
        var b = void 0;
        b = void 0 === b ? {} : b;
        var c = !1;
        N("ytLoggingEventsDefaultDisabled", !1) && Wl === Wl && (c = !0);
        c = c ? null : Wl;
        b = void 0 === b ? {} : b;
    ...
    var Xm = new Set,
        ...
        $m = 0,
        an = [],
        bn = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];

    function cn() {
        for (var a = t(bn), b = a.next(); !b.done; b = a.next()) {
            var c = Fb();
    ...
    function en(a) {
        return dn[a] || (dn[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function jn() {
        for (var a = t(gn), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function kn(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[en(b)] : a.getAttribute("data-" + b) : null;
        return c
    }
    ...
    function on(a, b, c) {
        pn || (pn = {}, nh(window, "message", function(d) {
            a: {
                if (d.origin === nn(a, "host")) {
                    try {
                    ...
                    if (d = pn[e.id]) d.u = !0, d.u && (D(d.v, d.sendMessage, d), d.v.length = 0), d.Ha(e)
                }
                e = void 0
            }
            return e
    ...
    m.destroy = function() {
        this.h && this.h.id && (fn[this.h.id] = null);
        var a = this.l;
    ...
    function vn(a, b) {
        ...
        c.setAttribute("title", "YouTube " + nn(a.i, "title"));
        (b = nn(a.i, "width")) && c.setAttribute("width", b.toString());
        (b = nn(a.i, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.Ka();
        ...
        c.src = nn(a.i, "host") + ("/embed/" + nn(a.i, "videoId")) + "?" + Ob(g);
        return c
    }
    m.Ua = function() {
    ...
    m.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Mb(a.src) : "https://www.youtube.com"), this.i = new mn(b), c || (b = vn(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Oa(this.h)), fn[this.h.id] = this, window.postMessage) {
                this.l = new L;
                wn(this);
                b = nn(this.i, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in hn) hn.hasOwnProperty(e) &&
                    tn(this, e)
            }
    };

    function sn(a, b) {
        a.I[b] || (a.I[b] = !0, un(a, "addEventListener", [b]))
    }
                    ...
                    if (!(Pb.message && 0 < Pb.message.indexOf("target origin ''"))) {
                        ...
                        if (f) {
                            ...
                            if (!(5 <= Ym)) {
                                ...
                                var cb = y.lineNumber || "Not available",
                                    ic = y.fileName || "Not available",
                                    Be = J,
                                    Z = z,
                                    S = 0;
                                if (p.hasOwnProperty("args") && p.args && p.args.length)
                                    for (var U = 0; U < p.args.length && !(S = Sm(p.args[U], "params." + U, Z, S), 500 <= S); U++);
                                        ...
                                        for (q in V) {
                                            if (V[q]) {
                                                var ka = "params." + q,
                                                    tj = Um(V[q]);
                                                Z[ka] = tj;
                                                S += ka.length + tj.length;
                                                if (500 < S) break
                                            }
                                        } else Z.params = Um(V)
                                }
                                if (an.length)
                                    for (var sd = 0; sd < an.length && !(S = Sm(an[sd], "params.context." + sd, Z, S), 500 <= S); sd++);
                                ...
                                var jb = {
                                    ...
                                    uj = Number(p.columnNumber);
                                isNaN(uj) || (jb.lineNumber = jb.lineNumber + ":" + uj);
                                if ("IGNORED" === p.level) n = 0;
                                else a: {
                                    for (var vj = Om(), wj = t(vj.X), pf = wj.next(); !pf.done; pf = wj.next()) {
                                        var xj = pf.value;
                                        if (jb.message &&
                                            jb.message.match(xj.Qb)) {
                                            n = xj.weight;
                                            break a
                                        }
                                    }
                                    for (var yj = t(vj.V), qf = yj.next(); !qf.done; qf = yj.next()) {
                                        var zj = qf.value;
                                        if (zj.fb(jb)) {
                                            n = zj.weight;
                                            break a
                                ...
                                jb.sampleWeight = n;
                                v = jb;
                                for (var Aj = t(Jm), rf = Aj.next(); !rf.done; rf = Aj.next()) {
                                    var sf = rf.value;
                                    if (sf.sa[v.name])
                                        for (var Bj = t(sf.sa[v.name]), tf = Bj.next(); !tf.done; tf = Bj.next()) {
                                            var Cj = tf.value,
                                                td = v.message.match(Cj.regexp);
                                            if (td) {
                                                v.params["params.error.original"] = td[0];
                                                for (var uf = Cj.groups, Dj = {}, Qb = 0; Qb < uf.length; Qb++) Dj[uf[Qb]] = td[Qb + 1], v.params["params.error." +
                                                    uf[Qb]] = td[Qb + 1];
                                                v.message = sf.Ca(Dj);
                                                break
                                            }
                                ...
                                v.params || (v.params = {});
                                var Ej = Om();
                                v.params["params.errorServiceSignature"] = "msg=" + Ej.X.length + "&cb=" + Ej.V.length;
                                v.params["params.serviceWorker"] = "false";
                                A.document && A.document.querySelectorAll && (v.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length));
                                vb("sample").constructor !== ub && (v.params["params.fconst"] = "true");
                                var pa = v;
                                window.yterr && "function" === typeof window.yterr && window.yterr(pa);
                                if (0 !== pa.sampleWeight && !Xm.has(pa.message)) {
                                    if ("ERROR" ===
                                        h) {
                                        Pm.ca("handleError", pa);
                                        if (P("record_app_crashed_web") && 0 === $m && 1 === pa.sampleWeight)
                                            if ($m++, P("errors_via_jspb")) {
                                                var vf = new Bg;
                                                G(vf, 1, 1);
                                                ...
                                                P("report_client_error_with_app_crash_ks") || (Kj.systemHealth = {
                                                    crashData: {
                                                        clientError: {
                                                            logMessage: {
                                                                message: pa.message
                                        ...
                                        Zm++
                                    } else "WARNING" === h && Pm.ca("handleWarning", pa);
                                    if (P("kevlar_gel_error_routing")) a: {
                                        ...
                                        if (P("errors_via_jspb")) {
                                            if (cn()) xf = void 0;
                                                ...
                                                var Fa = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Fa.length && (1 !== Fa.length || isNaN(Number(Fa[0])) ? 2 !== Fa.length || isNaN(Number(Fa[0])) || isNaN(Number(Fa[1])) || (G(Rb, 2, Number(Fa[0])), G(Rb, 3, Number(Fa[1]))) : G(Rb, 2, Number(Fa[0])));
                                                var kb =
                                                    new wg;
                                                G(kb, 1, R.message);
                                                G(kb, 3, R.name);
                                                G(kb, 6, R.sampleWeight);
                                                "ERROR" === rc ? G(kb, 2, 2) : "WARNING" === rc ? G(kb, 2, 1) : G(kb, 2, 0);
                                                var yf = new ug;
                                                G(yf, 1, !0);
                                                Tc(yf, 3, vg, Rb);
                                                var lb = new qg;
                                                G(lb, 3, window.location.href);
                                                for (var Lj = N("FEXP_EXPERIMENTS", []), zf = 0; zf < Lj.length; zf++) {
                                                    var Mj = lb,
                                                        Dn = Lj[zf];
                                                    Ec(Mj);
                                                    Oc(Mj, 5).push(Dn)
                                                ...
                                                var Af = $g();
                                                if (!ah() && Af)
                                                    for (var Nj = t(Object.keys(Af)), mb = Nj.next(); !mb.done; mb = Nj.next()) {
                                                        var Oj = mb.value,
                                                            Bf = new sg;
                                                        G(Bf, 1, Oj);
                                                        Bf.setValue(String(Af[Oj]));
                                                        Uc(lb, 4, sg, Bf)
                                                    }
                                                var Cf = R.params;
                                                if (Cf) {
                                                    var Pj =
                                                        t(Object.keys(Cf));
                                                    for (mb = Pj.next(); !mb.done; mb = Pj.next()) {
                                                        var Qj = mb.value,
                                                            Df = new sg;
                                                        G(Df, 1, "client." + Qj);
                                                        Df.setValue(String(Cf[Qj]));
                                                        Uc(lb, 4, sg, Df)
                                                    }
                                                }
                                                var Rj = N("SERVER_NAME", void 0),
                                                    Sj = N("SERVER_VERSION", void 0);
                                                if (Rj && Sj) {
                                                    var Ef = new sg;
                                                    G(Ef, 1, "server.name");
                                                    Ef.setValue(Rj);
                                            ...
                                            if (cn()) wf = void 0;
                                                ...
                                                0 !== Ga.length && (1 !== Ga.length || isNaN(Number(Ga[0])) ? 2 !== Ga.length || isNaN(Number(Ga[0])) || isNaN(Number(Ga[1])) || (sc.lineNumber = Number(Ga[0]), sc.columnNumber = Number(Ga[1])) : sc.lineNumber = Number(Ga[0]));
                                                var Gf = {
                                                ...
                                                "ERROR" === rc ? Gf.level = "ERROR_LEVEL_ERROR" : "WARNING" === rc && (Gf.level = "ERROR_LEVEL_WARNNING");
                                                var En = {
                                                        isObfuscated: !0,
                                                        browserStackInfo: sc
                                                    },
                                                ...
                                                var Hf = $g();
                                                if (!ah() && Hf)
                                                    for (var Vj = t(Object.keys(Hf)), nb = Vj.next(); !nb.done; nb = Vj.next()) {
                                                        var Wj = nb.value;
                                                        Sb.kvPairs.push({
                                                            key: Wj,
                                                            value: String(Hf[Wj])
                                                ...
                                                var If = R.params;
                                                if (If) {
                                                    var Xj = t(Object.keys(If));
                                                    for (nb = Xj.next(); !nb.done; nb = Xj.next()) {
                                                        var Yj = nb.value;
                                                        Sb.kvPairs.push({
                                                            key: "client." + Yj,
                                                            value: String(If[Yj])
                                                ...
                                                var Zj = N("SERVER_NAME", void 0),
                                                    ak = N("SERVER_VERSION", void 0);
                                                Zj && ak && (Sb.kvPairs.push({
                                                    key: "server.name",
                                                    value: Zj
                                                }), Sb.kvPairs.push({
                                                    key: "server.version",
                                            ...
                                            if (!bk) break a;
                                            Im("clientError", bk)
                                        }("ERROR" === rc || P("errors_flush_gel_always_killswitch")) && sm(void 0, void 0, !1)
                                    }
                                    if (!P("suppress_error_204_logging")) {
                                        ...
                                        tc.version && (Sa["client.version"] = tc.version);
                                        if (Sa.postParams) {
                                            ob.stack && (Sa.postParams.stack = ob.stack);
                                            for (var ck = t(Object.keys(tc)), Jf = ck.next(); !Jf.done; Jf = ck.next()) {
                                                var dk = Jf.value;
                                                Sa.postParams["client." + dk] = tc[dk]
                                            }
                                            var Kf = $g();
                                            if (Kf)
                                                for (var ek = t(Object.keys(Kf)), Lf = ek.next(); !Lf.done; Lf = ek.next()) {
                                                    var fk = Lf.value;
                                                    Sa.postParams[fk] = Kf[fk]
                                                }
                                            var gk = N("SERVER_NAME", void 0),
                                                hk = N("SERVER_VERSION", void 0);
                                            gk && hk &&
                                                (Sa.postParams["server.name"] = gk, Sa.postParams["server.version"] = hk)
                                        }
                                        Lh(N("ECATCHER_REPORT_HOST", "") + "/error_204", Sa)
                                    }
                                    try {
                                        Xm.add(pa.message)
                                    } catch (Jn) {}
    ...
    m.Ha = function(a) {
        ...
        switch (b) {
            ...
            case "initialDelivery":
                Na(a) && (window.clearInterval(this.j), this.playerInfo = {}, this.M = {}, Bn(this, a.apiInterface), An(this, a));
                break;
            default:
                rn(this, b, a)
        }
    ...
    m.getVideoEmbedCode = function() {
        var a = nn(this.i, "host") + ("/embed/" + nn(this.i, "videoId")),
            b = Number(nn(this.i, "width")),
            c = Number(nn(this.i, "height"));
    ...
    C("YT.subscribe", function(a, b, c) {
        Mf.subscribe(a, b, c);
        hn[a] = !0;
        for (var d in fn) fn.hasOwnProperty(d) && tn(fn[d], a)
    });
    C("YT.unsubscribe", function(a, b, c) { of (a, b, c)
    });
    C("YT.Player", zn);
    qn.prototype.destroy = qn.prototype.destroy;
    qn.prototype.setSize = qn.prototype.setSize;
    qn.prototype.getIframe = qn.prototype.getIframe;
    qn.prototype.addEventListener = qn.prototype.addEventListener;
    zn.prototype.getVideoEmbedCode = zn.prototype.getVideoEmbedCode;
    zn.prototype.getOptions = zn.prototype.getOptions;
    zn.prototype.getOption = zn.prototype.getOption;
    gn.push(function(a) {
        var b = a;
        b || (b = document);
        a = eb(b.getElementsByTagName("yt:player"));
        var c = b || document;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || jn();
    var Gn = A.onYTReady;
    Gn && Gn();
    var Hn = A.onYouTubeIframeAPIReady;
    Hn && Hn();
    var In = A.onYouTubePlayerAPIReady;
    In && In();
}).call(this);